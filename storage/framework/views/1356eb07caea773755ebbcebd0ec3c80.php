...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 shadow-md rounded-lg">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="<?php echo e(route('acciones.imprimir')); ?>" 
                 target="_blank" 
                ...
                <?php $__empty_1 = true; $__currentLoopData = $acciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-t hover:bg-gray-100">
                        <td class="px-6 py-4 flex justify-center items-center space-x-2">
                            <button 
                                data-modal-toggle="viewAccionModal-<?php echo e($accion['id']); ?>" 
                                class="bg-blue-600 text-white py-2 px-4 rounded-full hover:bg-blue-700 transition">
                                Ver
                            </button>
                            <button 
                                data-modal-toggle="editAccionModal-<?php echo e($accion['id']); ?>" 
                                class="bg-yellow-600 text-white py-2 px-4 rounded-full hover:bg-yellow-700 transition">
                                Editar
                            </button>
                            <button 
                                data-modal-toggle="deleteAccionModal-<?php echo e($accion['id']); ?>" 
    ...
    <div class="mt-4 text-center">
        <?php echo e($acciones->links('pagination::tailwind')); ?>
 ...
 <?php echo $__env->make('acciones.modals.createAccionModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
...
<?php $__currentLoopData = $acciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('acciones.modals.viewAccionModal', ['accion' => $accion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('acciones.modals.editAccionModal', ['accion' => $accion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
    <?php echo $__env->make('acciones.modals.deleteAccionModal', ['accion' => $accion], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 

<?php $__env->stopSection(); ?> 

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/acciones/index.blade.php ENDPATH**/ ?>