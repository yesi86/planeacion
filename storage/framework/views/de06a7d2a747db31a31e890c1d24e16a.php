<div id="createUserModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
...
</div><?php /**PATH /var/www/html/resources/views/users/modals/modaluser.blade.php ENDPATH**/ ?>