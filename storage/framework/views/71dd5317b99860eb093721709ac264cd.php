<div id="alertModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
...
<p id="alertMessage" class="hidden"><?php echo e(session('alert')); ?></p>
<?php /**PATH /var/www/html/resources/views/components/modals/modalAlert.blade.php ENDPATH**/ ?>