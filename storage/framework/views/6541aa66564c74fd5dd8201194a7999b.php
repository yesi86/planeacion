...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 shadow-md rounded-lg">
        <!-- Buscador -->
        <form method="GET" action="<?php echo e(route('users.index')); ?>" class="flex items-center space-x-2">
            <input 
                type="text" 
                name="search" 
                ...
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-t hover:bg-gray-100">
                        <td class="px-6 py-4 flex justify-center items-center space-x-2">
                            <button 
                                data-modal-toggle="viewUserModal-<?php echo e($user['id']); ?>" 
                                class="bg-blue-600 text-white py-2 px-4 rounded-full hover:bg-blue-700 transition">
                                    Ver
                            </button>
                           
                            <?php if(!$user->roles->contains('name', 'SuperAdministrador')): ?>
                            <button 
                                data-modal-toggle="editUserModal-<?php echo e($user['id']); ?>" 
                                class="bg-yellow-600 text-white py-2 px-4 rounded-full hover:bg-yellow-700 transition">
                                    Editar
                            </button>
                            <button 
                                data-modal-toggle="addUserModal-<?php echo e($user['id']); ?>" 
                                class="bg-green-600 text-white py-2 px-4 rounded-full hover:bg-green-700 transition">
                                    Agregar
                            </button>
                            <button 
                                data-modal-toggle="deleteUserModal-<?php echo e($user['id']); ?>" 
...
<?php echo $__env->make('users.modals.modaluser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('users.modals.deleteUserModal',['user'=>$user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('users.modals.viewUserModal',['user'=>$user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('users.modals.editUserModal',['user'=>$user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('users.modals.addUserModal',['user'=>$user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
