            ...
            <tbody>
                <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-100">
                        <td class="px-6 py-4"><?php echo e($actividad['Folio']); ?></td>
                        <td class="px-6 py-4"><?php echo e($actividad['descripcion']); ?></td>
                        <td class="px-6 py-4"><?php echo e($actividad['capitulo']); ?></td>
                        <td class="px-6 py-4"><?php echo e($actividad['partida']); ?></td>
                    </tr>
...
<?php /**PATH /var/www/html/resources/views/actividades/imprimir.blade.php ENDPATH**/ ?>