<div id="viewUserModal-<?php echo e($user->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl h-auto max-h-[80vh] overflow-hidden">
        ...
        <div class="bg-blue-600 px-4 py-3 border-b flex justify-between items-center text-white">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold">Detalles del usuario: <?php echo e($user->name); ?></h3>
            </div>
        ...
        <div class="bg-gray-100 px-4 py-3 border-t flex justify-end">
            <button type="button" data-modal-toggle="viewObjetivoModal-<?php echo e($user->id); ?>" class="closeModalButton bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">
                Cerrar
            </button>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/resources/views/users/modals/viewUserModal.blade.php ENDPATH**/ ?>