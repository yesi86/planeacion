<div id="editObjetoModal-<?php echo e($objeto->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form method="POST" action="<?php echo e(route('objeto.update', $objeto->id)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <!-- Campo de entrada -->
            <div class="bg-gray-100 rounded-md p-3 text-center mb-4">
                <span class="block font-semibold text-gray-800"><?php echo e($objeto['capitulo']); ?></span>
                <span class="block font-semibold text-gray-800"><?php echo e($objeto['partida']); ?></span>
                <span class="block font-semibold text-gray-800"><?php echo e($objeto['descripcion']); ?></span>
            </div>
            <div class="mb-6">
                <label for="partida" class="block font-medium text-gray-700 mb-1">Partida</label>
                <input type="text" id="partida" name="partida" class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Ingrese la nueva partida del objeto" value="<?php echo e(old('partida', '')); ?>">
            </div>
            <div class="mb-6">
...
<?php /**PATH /var/www/html/resources/views/objetoGasto/modals/editObjetoModal.blade.php ENDPATH**/ ?>