...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 shadow-md rounded-lg">
        <!-- Buscador -->
        <form method="GET" action="<?php echo e(route('objeto.index')); ?>" class="flex items-center space-x-2">
            <input 
                type="text" 
                name="search" 
            ...
            <form method="GET" action="<?php echo e(route('objeto.index')); ?>" class="flex items-center space-x-2">
                <select 
                    ...
                    <?php $__currentLoopData = $capitulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capitulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option 
                            value="<?php echo e($capitulo); ?>" 
                            <?php echo e(request('capitulo') === $capitulo ? 'selected' : ''); ?>>
                            <?php echo e($capitulo); ?>
    ...
    <div class="overflow-x-auto max-h-[400px] bg-white shadow-md rounded-lg"> <!-- Estilo de contenedor de tabla -->
        <table class="w-full border-collapse">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $objetoGasto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objeto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-t hover:bg-gray-100">
                        <td class="px-6 py-4 flex justify-center items-center space-x-2">
                            <button 
                                data-modal-toggle="editObjetoModal-<?php echo e($objeto['id']); ?>" 
                                class="bg-yellow-600 text-white py-2 px-4 rounded-full hover:bg-yellow-700 transition">
                                Editar
                            </button>
                            <button 
                                data-modal-toggle="deleteObjetoModal-<?php echo e($objeto['id']); ?>" 
                                class="bg-red-600 text-white py-2 px-4 rounded-full hover:bg-red-700 transition">
                                Eliminar
                            </button>
                        </td>
                        <td class="px-6 py-4"><?php echo e($objeto->capitulo); ?></td>
                        <td class="px-6 py-4"><?php echo e($objeto->partida); ?></td>
                        <td class="px-6 py-4"><?php echo e($objeto->descripcion); ?></td>
                    </tr>
    ...
    <div class="mt-4 text-center">
        <?php echo e($objetoGasto->links('pagination::tailwind')); ?>

    </div>
</div>

<?php echo $__env->make('objetoGasto.modals.createObjetoModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<!-- incorporamos los modals con foreach-->
<?php $__currentLoopData = $objetoGasto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objeto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('objetoGasto.modals.editObjetoModal',['objeto'=>$objeto], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('objetoGasto.modals.deleteObjetoModal',['objeto'=>$objeto], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/objetoGasto/index.blade.php ENDPATH**/ ?>