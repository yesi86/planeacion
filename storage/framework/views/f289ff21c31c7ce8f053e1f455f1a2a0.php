...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 shadow-md rounded-lg">
        <!-- Buscador -->
        <form method="GET" action="<?php echo e(route('puestos.index')); ?>" class="flex items-center space-x-2" >
            <input 
                type="text" 
                name="search" 
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="<?php echo e(route('puestos.imprimir')); ?>" 
                 target="_blank" 
    ...
    <div id="paginacion" class="mt-4 text-center">
        <?php echo e($puestos->links('pagination::tailwind')); ?>

    </div>
</div>

<!-- Incluir el modal desde la carpeta components/modals -->
<?php echo $__env->make('puestos.modals.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__currentLoopData = $puestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('puestos.modals.deletePuestoModal', ['puesto' => $puesto], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('puestos.modals.edit', ['puesto' => $puesto], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/puestos/index.blade.php ENDPATH**/ ?>