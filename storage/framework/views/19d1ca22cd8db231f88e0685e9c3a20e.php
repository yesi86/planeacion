...
<body class="font-sans text-gray-900 antialiased">
    ...
    <div class="relative min-h-screen bg-cover bg-center" style="background-image: url('<?php echo e(asset('images/background.jpg')); ?>');">
        ...
        <div class="absolute top-5 right-5 z-10">
            <a href="<?php echo e(route('login')); ?>" class="px-6 py-3 font-semibold text-white bg-green-600 rounded hover:bg-green-700">
                Iniciar sesión
            </a>
        </div>
