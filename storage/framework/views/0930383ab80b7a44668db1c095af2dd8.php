<div id="editAreaModal-<?php echo e($area->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
...
<?php /**PATH /var/www/html/resources/views/estructura/modals/editAreaModal.blade.php ENDPATH**/ ?>