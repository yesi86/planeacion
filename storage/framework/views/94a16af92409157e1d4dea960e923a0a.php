<div id="createAccionModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e(request()->has('showModal') || $errors->any() ? 'block' : 'hidden'); ?>">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
       ...
       <h3 class="text-center text-2xl font-semibold text-gray-800 mb-4">Crear Nueva accion</h3>
        <form id="createAccionForm" method="POST" action="<?php echo e(route('acciones.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                       value="<?php echo e(old('descripcion')); ?>" required placeholder="Escriba la descripción de la acción">
...
<?php /**PATH /var/www/html/resources/views/acciones/modals/createAccionModal.blade.php ENDPATH**/ ?>