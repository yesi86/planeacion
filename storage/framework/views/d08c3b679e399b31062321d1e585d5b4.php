<div id="editPuestoModal-<?php echo e($puesto->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form method="POST" action="<?php echo e(route('puestos.update', $puesto->id)); ?>">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/resources/views/puestos/modals/edit.blade.php ENDPATH**/ ?>