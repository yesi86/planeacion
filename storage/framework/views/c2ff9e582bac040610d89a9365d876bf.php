<div id="editUserModal-<?php echo e($user->id); ?>" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?php echo e($errors->any() ? 'block' : 'hidden'); ?>">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <!-- Título -->
        <h3 class="text-center text-2xl font-semibold text-gray-800 mb-4">Editar Usuario</h3>
        ...
        <form method="POST" action="<?php echo e(route('users.update', $user->id)); ?>">
            ...
            <div class="mb-4">
                ...
                <select id="role" name="role" class="w-full border border-gray-300 rounded-lg p-2">
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($role->name); ?>" <?php echo e($user->roles->first()->name === $role->name ? 'selected' : ''); ?>>
...
<?php /**PATH /var/www/html/resources/views/users/modals/editUserModal.blade.php ENDPATH**/ ?>