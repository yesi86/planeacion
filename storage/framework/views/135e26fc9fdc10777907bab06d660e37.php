...
<?php endif; ?>
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 shadow-md rounded-lg">
        <!-- Buscador -->
        <form method="GET" action="<?php echo e(route('actividad.index')); ?>" class="flex items-center space-x-2">
            <input 
                type="text" 
                name="search" 
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="<?php echo e(route('actividades.imprimir')); ?>" 
                 target="_blank" 
    ...
    <div class="overflow-y-auto max-h-[400px] bg-white shadow-md rounded-lg"> <!-- Estilo de contenedor de tabla -->
        <table class="w-full border-collapse">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-t hover:bg-gray-100">
                        <td class="px-6 py-4 flex justify-center items-center space-x-2">
                            <button 
                                data-modal-toggle="viewActiModal-<?php echo e($acti['id']); ?>" 
                                class="bg-blue-600 text-white py-2 px-4 rounded-full hover:bg-blue-700 transition">
                                Ver
                            </button>
                            <button 
                                data-modal-toggle="editActiModal-<?php echo e($acti['id']); ?>" 
                                class="bg-yellow-600 text-white py-2 px-4 rounded-full hover:bg-yellow-700 transition">
                                Editar
                            </button>
                            <button 
                                data-modal-toggle="deleteActiModal-<?php echo e($acti['id']); ?>" 
                                class="bg-red-600 text-white py-2 px-4 rounded-full hover:bg-red-700 transition">
                                Eliminar
                            </button>
                        </td>
                        <td class="px-6 py-4"><?php echo e($acti['Folio']); ?></td>
                        <td class="px-6 py-4"><?php echo e($acti['descripcion']); ?></td>
                    </tr>
    ...
    <div class="mt-4 text-center">
        <?php echo e($actividades->links('pagination::tailwind')); ?>
 ...
 <?php echo $__env->make('actividades.modals.createActiModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    

<!-- Modal para ver, editar y eliminar -->
<?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('actividades.modals.viewActiModal', ['acti' => $acti], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('actividades.modals.editActiModal', ['acti' => $acti], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
    <?php echo $__env->make('actividades.modals.deleteActiModal', ['acti' => $acti], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 

<?php $__env->stopSection(); ?> 

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/actividades/index.blade.php ENDPATH**/ ?>